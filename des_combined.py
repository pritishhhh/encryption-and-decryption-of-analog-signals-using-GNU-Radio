...
import sip
import threading
import untitled_des_block as des_block  # embedded python block
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_stream_to_vector_0, 0), (self.des_block, 0))
        ...
        self.connect((self.des_block, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.des_block, 1), (self.blocks_vector_to_stream_0_0, 0))
        self.connect((self.des_block, 2), (self.blocks_vector_to_stream_0_0_0, 0))
